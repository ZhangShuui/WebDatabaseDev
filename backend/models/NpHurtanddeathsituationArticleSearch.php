...
/**
 * NpHurtanddeathsituationArticleSearch represents the model behind the search form of `backend\models\NpHurtanddeathsituationArticle`.
 */
class NpHurtanddeathsituationArticleSearch extends NpHurtanddeathsituationArticle
{
    ...
    {
        $query = NpHurtanddeathsituationArticle::find();
