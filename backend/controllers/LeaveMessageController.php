...
use backend\models\LeaveMessageSearch;
...
class LeaveMessageController extends Controller
{
    ...
    /**
     * Creates a new LeaveMessage model.
    ...
    /**
     * Updates an existing LeaveMessage model.
    ...
    /**
     * Deletes an existing LeaveMessage model.
    ...
    {
        if (($model = LeaveMessage::findOne(['id' => $id])) !== null) {
            return $model;
        }
